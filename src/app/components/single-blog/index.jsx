...
const SingleBlog = ({ blog }) => {
    return (
        <article className="relative group bg-white/95 shadow-xl rounded-3xl p-10 mb-4 border-l-8 border-green-900/80 hover:border-green-700/90 hover:bg-green-50 cursor-pointer transition-all duration-300 overflow-hidden">
